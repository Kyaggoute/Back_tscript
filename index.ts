...
class PersonProvider extends BaseProvider {
  protected getData():Person[] {
    //:person[]
    let p1:Person = new Person(); //person
    p1.id = 1;
    p1.firstname = "Sophie";
    p1.lastname = "Lozophy";

    let p2:Person = new Person(); //person
    p2.id = 2;
    p2.firstname = "Annie";
    p2.lastname = "Versaire";

    let p3:Person = new Person(); //person
    p3.id = 3;
    p3.firstname = "Paul";
    p3.lastname = "Ochon";
...
class CompanyProvider extends BaseProvider {
  protected getData():Company[] {
    //:Compagny[]
    let c1:Company = new Company(); //compagny
    c1.id = 1;
    c1.name = "Google";

    let c2: Company = new Company(); //compagny
    c2.id = 2;
    c2.name = "Apple";

    let c3:Company = new Company(); //compagny
    c3.id = 3;
    c3.name = "Microsoft";
